...
abstract class BaseProductoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sub_clasificacion_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('SubClasificacion'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'sub_clasificacion_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('SubClasificacion'), 'column' => 'id')),
  ...
  public function getFields()
  {
    return array(
      ...
      'sub_clasificacion_id' => 'ForeignKey',
      'created_at'           => 'Date',
      'updated_at'           => 'Date',
