...
abstract class BaseProductoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'clasificacion_id'     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Clasificacion'), 'add_empty' => false)),
      'sub_clasificacion_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('SubClasificacion'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'clasificacion_id'     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Clasificacion'))),
      'sub_clasificacion_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('SubClasificacion'))),
