...
//			$smallFile = 'images/catalogo/small/'.$file;
                        ...
                        $real_name =  $file;
			$file = 'uploads/fotos_productos/'.$file;
		}
                //echo $file; die;
...
//                echo $directory."<br>"; die;
		...
		// copy the temp file to the destination file     PARA UNA IMAGEN MAS CHIQUITA
...
//		$thumbnail->save($smallFile, 'web_images');
		...
		$thumbnail = new sfThumbnail(300, 300, false, false, 100, 'sfImageMagickAdapter');
		$thumbnail->loadFile($this->getTempName());
		$thumbnail->save($file, 'web_images');
		...
		chmod($file, $fileMode);
                //echo $file; die;
		$this->savedName = $file;
		return is_null($this->path) ? $file : str_replace($this->path.DIRECTORY_SEPARATOR, '', $real_name);
	}
